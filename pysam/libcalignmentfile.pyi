...
# IteratorColumnRecords cannot subclass IteratorColumn, since the latter
# requires an open AlignmentFile; the two families are related structurally,
# through this protocol, rather than through class inheritance.
class PileupColumnIterator(Protocol):
    def __iter__(self) -> PileupColumnIterator: ...
...
class IteratorColumn(PileupColumnIterator):
...
class IteratorColumnRecords(PileupColumnIterator):
    def __init__(
        self,
    ...
    def __iter__(self) -> IteratorColumnRecords: ...
    def __next__(self) -> PileupColumn: ...
    @property
    def seq_len(self) -> int: ...
    def add_reference(self, fastafile: FastaFile) -> None: ...
