...
class AlignedSegment:
    ...
    @overload
    def get_aligned_pairs(
        self, matches_only: Literal[False] = ..., with_seq: Literal[True] = ..., with_cigar: Literal[True] = ...
    ) -> List[Tuple[int, Optional[int], Optional[str], int]]: ...
    @overload
    def get_aligned_pairs(
        self, matches_only: Literal[False] = ..., with_seq: Literal[True] = ..., with_cigar: Literal[False] = ...
    ) -> List[Tuple[int, Optional[int], Optional[str]]]: ...
    @overload
    def get_aligned_pairs(
        self, matches_only: Literal[False] = ..., with_seq: Literal[False] = ..., with_cigar: Literal[True] = ...
    ) -> List[Tuple[int, Optional[int], int]]: ...
    @overload
    def get_aligned_pairs(
        self, matches_only: Literal[False] = ..., with_seq: Literal[False] = ..., with_cigar: Literal[False] = ...
