...
@overload
def reverse_complement(seq: bytearray) -> bytearray: ...
@overload
def reverse_complement(seq: Union[bytes, memoryview]) -> bytes: ...
@overload
def reverse_complement(seq: int) -> int: ...

def reverse_complement_inplace(seq: Union[bytearray, memoryview]) -> None: ...
...
class AlignedSegment:
    ...
    @overload
    def get_aligned_pairs(self, matches_only: Literal[True], with_seq: Literal[False] = ..., with_cigar: Literal[False] = ...) -> List[Tuple[int, int]]: ...  # type: ignore[overload-overlap]
    @overload
    def get_aligned_pairs(self, matches_only: Literal[True], with_seq: Literal[False] = ..., with_cigar: Literal[True] = ...) -> List[Tuple[int, int, CIGAR_OPS]]: ...  # type: ignore[overload-overlap]
    @overload
    def get_aligned_pairs(self, matches_only: Literal[True], with_seq: Literal[True], with_cigar: Literal[False] = ...) -> List[Tuple[int, int, str]]: ...  # type: ignore[overload-overlap]
    @overload
