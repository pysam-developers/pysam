...
class AlignedSegment:
    ...
    @overload
    def get_aligned_pairs(self, matches_only: Literal[False] = ..., with_seq: Literal[False] = ..., with_cigar: Literal[False] = ...) -> List[Tuple[Optional[int], Optional[int]]]: ...
    @overload
    def get_aligned_pairs(self, matches_only: Literal[False] = ..., with_seq: Literal[False] = ..., with_cigar: Literal[True] = ...) -> List[Tuple[Optional[int], Optional[int], CIGAR_OPS]]: ...
    @overload
    def get_aligned_pairs(self, matches_only: Literal[False] = ..., with_seq: Literal[True] = ..., with_cigar: Literal[False] = ...) -> List[Tuple[Optional[int], Optional[int], Optional[str]]]: ...
    @overload
    def get_aligned_pairs(self, matches_only: Literal[False] = ..., with_seq: Literal[True] = ..., with_cigar: Literal[True] = ...) -> List[Tuple[Optional[int], Optional[int], Optional[str], CIGAR_OPS]]: ...
