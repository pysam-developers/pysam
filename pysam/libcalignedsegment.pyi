...
class AlignedSegment:
    ...
    def get_aligned_pairs(
        self, matches_only: Literal[True], with_seq: Literal[False] = ..., with_cigar: Literal[False] = ...
    ) -> List[Tuple[int, int]]: ...
    @overload
    def get_aligned_pairs(
        self, matches_only: Literal[True], with_seq: Literal[False], with_cigar: Literal[True]
    ) -> List[Tuple[int, int, CIGAR_OPS]]: ...
    @overload
    def get_aligned_pairs(
        self, matches_only: Literal[True], with_seq: Literal[True], with_cigar: Literal[False] = ...
    ) -> List[Tuple[int, int, str]]: ...
    @overload
    def get_aligned_pairs(
        self, matches_only: Literal[True], with_seq: Literal[True], with_cigar: Literal[True]
    ) -> List[Tuple[int, int, str, CIGAR_OPS]]: ...
    @overload
    def get_aligned_pairs(
        self, matches_only: bool = ..., with_seq: Literal[False] = ..., with_cigar: Literal[False] = ...
    ) -> List[Tuple[Optional[int], Optional[int]]]: ...
    @overload
    def get_aligned_pairs(
        self, matches_only: bool, with_seq: Literal[False], with_cigar: Literal[True]
    ) -> List[Tuple[Optional[int], Optional[int], CIGAR_OPS]]: ...
    @overload
    def get_aligned_pairs(
        self, matches_only: bool, with_seq: Literal[True], with_cigar: Literal[False] = ...
    ) -> List[Tuple[Optional[int], Optional[int], Optional[str]]]: ...
    @overload
    def get_aligned_pairs(
        self, matches_only: bool, with_seq: Literal[True], with_cigar: Literal[True]
    ) -> List[Tuple[Optional[int], Optional[int], Optional[str], CIGAR_OPS]]: ...
    @overload
    def get_aligned_pairs(
